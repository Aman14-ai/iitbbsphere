      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-md md:text-lg text-muted-foreground max-w-lg">
            ...
            access past exam papers, notes, and study guides. The platform
            builds on IIT BBS’s collaborative learning by fostering peer
            support , so this
            site connects juniors to share knowledge and prepare together.
          </p>
